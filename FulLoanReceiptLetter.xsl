...
<!-- Overskriver avsenderadresse i XML med avsenderbibliotekets e-post -->
<xsl:param name="pReplacement" select="'biblioteket@bi.no'"/>
...
<xsl:template match="notification_data/general_data/address_from/text()">
