	...
	<html>
		...
		<xsl:call-template name="generalStyle" />
			...
			<table cellspacing="0" cellpadding="5" border="0">
				...
				<tr>
			 		<td>
						<h1><xsl:value-of select="notification_data/user_for_printing/name"/>
						&#160;
						(<xsl:value-of select="notification_data/user_for_printing/identifiers/code_value[1]/value"/>)</h1>
					</td>
					<td align="right">
