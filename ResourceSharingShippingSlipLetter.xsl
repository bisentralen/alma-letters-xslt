...
<div align="bottom">
	...
	Til libnummer:
	<h1>
        <xsl:value-of select="substring(notification_data/partner_shipping_info_list/partner_shipping_info[1]/address5, 4,3)"/>&#160;&#160;&#160;<xsl:value-of select="substring(notification_data/partner_shipping_info_list/partner_shipping_info[1]/address5, 7,4)"/>
	</h1>
</div>
